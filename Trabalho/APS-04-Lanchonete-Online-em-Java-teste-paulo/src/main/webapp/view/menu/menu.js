function loadData(){
    requisicao('../../listarTodos', getLanches);
...
function showLanches() {
    const lanches = document.getElementById("screen");
    const bebidas = document.getElementById("screenBebidas");
    const porcoes = document.getElementById("screenPorcoes");
